...
: ${AMENT_CURRENT_PREFIX:="/workspace/github/opticore-amr/ros2_ws/src/install/amr_fleet"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/amr_fleet/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/amr_fleet/environment/path.sh"
